...
var bootstrap = Environment.GetEnvironmentVariable("KAFKA");
if (string.IsNullOrWhiteSpace(bootstrap))
{
    Console.Error.WriteLine("ERROR: KAFKA environment variable must be set to the Kafka broker address (e.g., redpanda:9092)");
    Environment.Exit(1);
}
